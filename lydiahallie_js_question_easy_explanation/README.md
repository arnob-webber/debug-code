...
> [!NOTE]  
> This repo was created in 2019 and the questions provided here are therefore based on the JavaScript syntax and behavior at that time.

---

> [!IMPORTANT]
> I copied a JavaScript question from a GitHub repository so I could explain it easily.

<p align="center">Feel free to reach out to lydia hallie 😊</p>
...
### Explanetion by Arnob

```javascript
function sayHi() {
  // This will log 'undefined' because 'name' is hoisted but not initialized yet.
  console.log(name); // Output: undefined

  // This will throw a ReferenceError because 'age' is not hoisted.
  console.log(age); // Output: ReferenceError: Cannot access 'age' before initialization

  // 'name' is declared and initialized here.
  var name = "Lydia";

  // 'age' is declared and initialized here.
  let age = 21;
}
